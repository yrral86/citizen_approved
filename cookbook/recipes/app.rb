...
deploy 'citizen_approved' do
  ...
  migration_command "export RAILS_ENV=#{node.chef_environment}; /opt/citizen_approved/.rvm/gems/ruby-#{['citizen_approved']['app']['ruby_version']}@global/bin/bundle exec rake db:migrate"
  migrate true
  restart_command do 
